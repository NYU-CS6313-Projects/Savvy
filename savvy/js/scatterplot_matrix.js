  ...
  var matrix1 = c3.generate({
    bindto: '#scatterplot-PostGeoSum-PreGeoSum',
    data: {
      json: studentDemographics,
      // onselected: function (d) { updateSelection() },
      // onunselected: function (d) { updateSelection() },
  ...
  var matrix2 = c3.generate({
    bindto: '#scatterplot-PostGeoSum-PrePostGeoGain',
    data: {
      json: studentDemographics,
      // onselected: function (d) { updateSelection() },
      // onunselected: function (d) { updateSelection() },
    ...
    var matrix3 = c3.generate({
    bindto: '#scatterplot-PostGeoSum-SIC_SUM',
    data: {
      json: studentDemographics,
      // onselected: function (d) { updateSelection() },
      // onunselected: function (d) { updateSelection() },
  ...
  var matrix4 = c3.generate({
    bindto: '#scatterplot-PostGeoSum-IIGeo_SUM',
    data: {
      json: studentDemographics,
      // onselected: function (d) { updateSelection() },
      // onunselected: function (d) { updateSelection() },
  ...
  var matrix5 = c3.generate({
    bindto: '#scatterplot-PostGeoSum-IIGC_SUM',
    data: {
      json: studentDemographics,
      // onselected: function (d) { updateSelection() },
      // onunselected: function (d) { updateSelection() },
   ...
   var matrix6 = c3.generate({
    bindto: '#scatterplot-PostGeoSum-BIS_SUM',
    data: {
      json: studentDemographics,
      // onselected: function (d) { updateSelection() },
      // onunselected: function (d) { updateSelection() },
